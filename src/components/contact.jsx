        ...
        <div className="container mt-7">
          ...
          <div className="fade-right">
            <Carousel
              ...
              className=" w-[95%] sm:w-[60%] shadow-lg"
            >
              <div className=" text-white bg-gray-800 rounded-lg p-8 flex flex-col items-center justify-center">
                ...
                <a
                  ...
                  className="text-white-500 hover:text-blue-500 transition duration-300"
                >
              ...
              <div className="text-white bg-gray-800 rounded-lg p-8 flex flex-col items-center justify-center">
                <div className="flex items-center mb-8">
                  ...
                  <a
                    href="https://www.linkedin.com/in/anuragkumar17/"
                    target="_blank"
                ...
                <div className="flex items-center mb-2">
                  ...
                  <a
                    href="https://github.com/d17012002"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white-500 hover:text-blue-500 transition duration-300"
                  >
